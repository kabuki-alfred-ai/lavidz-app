      ...
      <CardContent className="p-6">
        <div className="flex items-start justify-between">
          <div>
            ...
            {sub && (
              <p className="text-[10px] font-mono text-muted-foreground/40 mt-1 uppercase tracking-wider">
                {sub}
              </p>
            )}
          </div>
              ...
              {recentSessions.map((s: any) => (
                <div key={s.id} className="grid grid-cols-[1fr_90px_130px] items-center px-5 py-4 hover:bg-primary/[0.02] transition-colors group">
                  <div className="min-w-0 pr-4">
                    ...
                    <p className="text-[10px] font-mono text-muted-foreground/60 truncate">{s.recipientEmail || s.recipientName || 'Anonyme'}</p>
