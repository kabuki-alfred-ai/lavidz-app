  ...
  return (
    <AbsoluteFill style={{ background: '#000000', overflow: 'hidden' }}>
      ...
      >
        ...
        >
          {/* Orange square dot with satellite */}
          <div
            style={{
              position: 'relative',
              width: 28,
              height: 28,
              flexShrink: 0,
              transform: `scale(${dotScale}) rotate(${dotRotate}deg)`,
              opacity: dotScale,
            }}
          >
            <div style={{ width: 28, height: 28, background: '#FF4D1C' }} />
            <div
              style={{
                position: 'absolute',
                top: -5,
                ...
                width: 13,
                height: 13,
                background: 'rgba(255,77,28,0.45)',
              }}
            />
          </div>
        ...
        >
          ...
          <div
            style={{
              ...
              alignItems: 'center',
              gap: 16,
              transform: `scale(${kabukiSvgScale})`,
